 ...
 * direction. Built by Nick Butcher.
 */
public class SlideInItemAnimator extends DefaultItemAnimator {

  private final List<ViewHolder> pendingAdds = new ArrayList<>();
      ...
      for (int i = pendingAdds.size() - 1; i >= 0; i--) {
        ...
        holder.itemView.animate()
            ...
            .setInterpolator(AnimationUtils.loadInterpolator(
                holder.itemView.getContext(), android.R.interpolator.linear_out_slow_in));
